...
4. **Update Project References**  
   ...
   - Find all instances of `aimeeUberMod` and replace them with your mod name, e.g., `MyStationeersMod`.  
   - Click **Replace All**.

5. **Update Project Properties**  
   - On the top menu, go to **Project → [YourModName] Properties**.  
   - Change both the **Assembly Name** and **Default Namespace** from `aimeeUberMod` to your mod name.
